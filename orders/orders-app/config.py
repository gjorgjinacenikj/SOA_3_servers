...
products_port = int(os.getenv('products_port')) if os.getenv('products_port') else 8001
orders_port = int(os.getenv('orders_port')) if os.getenv('orders_port') is not None else 8002
reviews_port = int(os.getenv('reviews_port')) if os.getenv('reviews_port') is not None else 8003
consul_port = int(os.getenv('consul_port')) if os.getenv('consul_port') is not None else 8004
